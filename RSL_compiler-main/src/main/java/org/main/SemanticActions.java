...
public class SemanticActions {
    ...
    public void visit_assignstatement(ExtendedASTNode node) {
        ...
        operandType = switch (node.getChildren().get(2).getType()) {
            ...
            case "returnFunction" -> "FunctionCall " ;
            case "string" -> "StringOperand ''"; // 假设 getValue 返回字符串值
        ...
        if(!operandType.contains("FunctionCall")){
            IR assignIR = new IR("ASSIGN",Arrays.asList("Identifier ''" + id + "''",operandType + value + "''"));
            ...
            IR functionCallIR = new IR("FunctionCall " + node.getChildrenByType("returnFunction").getChildren().get(0).getType()
                    , Arrays.asList("Identifier ''" + midVar + "''"));
            // 创建第二个节点表示将 midVar 赋值给目标变量 id
            IR assignIR = new IR("ASSIGN", Arrays.asList("Identifier ''" + id + "''", "Identifier ''" + midVar + "''"));
    ...
    public void visit_boolExp(ExtendedASTNode node) {
        ...
        for (int i = 1; i < node.getChildren().size(); i += 2) {
            ...
            String boolOp = boolOpNode.getChildren().get(0).getValue(); // 获取 boolop 的值
    ...
    public void visit_forwardCommand(ExtendedASTNode node) {
        ...
        IR assignIR = new IR("CustomOp FORWARD",Arrays.asList("MathExp ''" + operand + "''"));
        CFGNode assignNode = new BlockNode(Arrays.asList(assignIR));
        cfg.addNode(assignNode);
    ...
    public void visit_backwardCommand(ExtendedASTNode node) {
        ...
        IR assignIR = new IR("CustomOp BACKWARD",Arrays.asList("MathExp ''" + operand + "''"));
        CFGNode assignNode = new BlockNode(Arrays.asList(assignIR));
        cfg.addNode(assignNode);
    ...
    public void visit_turnrightCommand(ExtendedASTNode node) {
        ...
        IR assignIR = new IR("CustomOp TURNRIGHT",Arrays.asList("MathExp ''" + operand + "''"));
        CFGNode assignNode = new BlockNode(Arrays.asList(assignIR));
        cfg.addNode(assignNode);
    ...
    public void visit_turnleftCommand(ExtendedASTNode node) {
        ...
        IR assignIR = new IR("CustomOp TURNLEFT",Arrays.asList("MathExp ''" + operand + "''"));
        CFGNode assignNode = new BlockNode(Arrays.asList(assignIR));
        cfg.addNode(assignNode);
    ...
    public void visit_gotoCommand(ExtendedASTNode node) {
        ...
        IR assignIR = new IR("CustomOp GOTO",Arrays.asList("MathExp ''" + number0 + "''" , "MathExp ''" + number1 + "''"));
        CFGNode assignNode = new BlockNode(Arrays.asList(assignIR));
        cfg.addNode(assignNode);
    ...
    public void visit_approachCommand(ExtendedASTNode node) {
        ...
        IR assignIR = new IR("CustomOp APPROACH",Arrays.asList("StringOperand ''" + s + "''"));
        CFGNode assignNode = new BlockNode(Arrays.asList(assignIR));
        cfg.addNode(assignNode);
    ...
    public void visit_graspCommand(ExtendedASTNode node) {
        ...
        IR assignIR = new IR("CustomOp GRASP",Arrays.asList("StringOperand ''" + s + "''"));
        CFGNode assignNode = new BlockNode(Arrays.asList(assignIR));
        cfg.addNode(assignNode);
    ...
    public void visit_slamCommand(ExtendedASTNode node) {
        ...
        IR assignIR = new IR("CustomOp SLAM",Arrays.asList());
        CFGNode assignNode = new BlockNode(Arrays.asList(assignIR));
        cfg.addNode(assignNode);
    ...
    public void visit_perceiveCommand(ExtendedASTNode node) {
        ...
        IR assignIR = new IR("CustomOp PERCEIVE",Arrays.asList());
        CFGNode assignNode = new BlockNode(Arrays.asList(assignIR));
        cfg.addNode(assignNode);
    ...
    public void visit_releaseCommand(ExtendedASTNode node) {
        ...
        IR assignIR = new IR("CustomOp RELEASE",Arrays.asList());
        CFGNode assignNode = new BlockNode(Arrays.asList(assignIR));
        cfg.addNode(assignNode);
